...
> **Status: private beta, release `v0.7.0`.** Self-hosting is supported for
...
Operators install the server from the published `v0.7.0` release. Agent
operators use the versioned remote-agent ZIP and verify it against
`SHA256SUMS` from the same
[GitHub Release](https://github.com/omrylcn/loca/releases/tag/v0.7.0).
